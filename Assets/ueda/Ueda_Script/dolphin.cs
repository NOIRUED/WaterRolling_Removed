...
public class dolphin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Boatdistance3 = Vector3.Distance(Boat3.transform.position, transform.position);
        if ((Boatdistance1 <= Boatdistance2 && Boatdistance1 <= Boatdistance3)&& Boatdistance1 <= 50f && dolphinbool == false && Boatdistance1 >= 5f) {
        ...
        } else if ((Boatdistance2 <= Boatdistance1 && Boatdistance2 <= Boatdistance3) && Boatdistance2 <= 50f && dolphinbool == false && Boatdistance2 >= 5f) {
        ...
        } else if ((Boatdistance3 <= Boatdistance1 && Boatdistance3 <= Boatdistance2) && Boatdistance3 <= 50f && dolphinbool == false && Boatdistance3 >= 5f) {
            StartCoroutine(dolphinattack(Boat3));
            var aim = Boat3.transform.position - this.transform.position;
            var look = Quaternion.LookRotation(aim);
            this.transform.localRotation = look;
            var step = Speed * Time.deltaTime;
            transform.position = Vector3.MoveTowards(transform.position, Boat3.transform.position, step);
        }
